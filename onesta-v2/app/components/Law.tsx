      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 60px' }}>
        <div style={{
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #1A2E44, #0D1B2A)',
              borderRadius: 16,
              padding: 48,
            ...
            {[
              {
                ...
                accent: true,
                suffix: ' años',
                label: 'de vigencia de la Ley 27.401 — y cada vez más empresas son inspeccionadas por organismos de control.',
              },
              {
                num: 'ISO',
                accent: true,
                suffix: ' 37001',
                label: 'Estándar internacional de Sistema de Gestión Anticorrupción. Acompañamos tu proceso de certificación de inicio a fin.',
              },
              {
                num: '0',
                accent: true,
                suffix: ' plantillas',
                label: 'Todos nuestros programas son diseñados desde cero, a medida del tamaño, sector y riesgos específicos de tu organización.',
              },
            ].map((stat, i, arr) => (
              <div
                key={stat.label}
              ...
              >
                <div style={{
                  ...
                  <span style={{ color: '#1D72B8' }}>{stat.num}</span>
                  {stat.suffix}
                </div>
                <div style={{ fontSize: '0.82rem', color: '#7A95A8', lineHeight: 1.6 }}>
                  {stat.label}
                </div>
              </div>
            ))}
